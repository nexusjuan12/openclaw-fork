...
export type ToolsConfig = {
  ...
  web?: {
    search?: {
      ...
      enabled?: boolean;
      /** Search provider ("brave", "perplexity", or "searxng"). */
      provider?: "brave" | "perplexity" | "searxng";
      ...
      searxng?: {
        /** Base URL for the SearXNG instance (defaults to SEARXNG_BASE_URL env var or http://127.0.0.1:8888). */
        baseUrl?: string;
      };
    };
    fetch?: {
